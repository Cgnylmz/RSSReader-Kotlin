 ...
 * @author Patrik Mucha
 */
class RSSFeedViewHolder(private val mItemView: View) : RecyclerView.ViewHolder(mItemView) {
    ...
    fun setRSSFeedItem(item: RSSFeedItem) {
        ...
        mItemView.feed_item_description.text = Html.fromHtml(item.mDescription)
